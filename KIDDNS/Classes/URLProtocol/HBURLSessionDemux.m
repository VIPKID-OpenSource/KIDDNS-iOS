...
@interface HBURLSessionDemuxTaskInfo : NSObject
...
@interface HBURLSessionDemuxTaskInfo ()
...
@implementation HBURLSessionDemuxTaskInfo
...
@interface HBURLSessionDemux () <NSURLSessionDataDelegate>
...
@implementation HBURLSessionDemux
...
- (instancetype)initWithConfiguration:(NSURLSessionConfiguration *)configuration
{
    ...
    if (self != nil) {
        ...
        [self->_sessionDelegateQueue setName:@"HBURLSessionDemux"];
        ...
        self->_session.sessionDescription = @"HBURLSessionDemux";
    }
    return self;
}
...
- (NSURLSessionDataTask *)dataTaskWithRequest:(NSURLRequest *)request delegate:(id<NSURLSessionDataDelegate>)delegate modes:(NSArray *)modes
{
    ...
    HBURLSessionDemuxTaskInfo *    taskInfo;
    ...
    taskInfo = [[HBURLSessionDemuxTaskInfo alloc] initWithTask:task delegate:delegate modes:modes];
...
- (HBURLSessionDemuxTaskInfo *)taskInfoForTask:(NSURLSessionTask *)task
{
    HBURLSessionDemuxTaskInfo *    result;
